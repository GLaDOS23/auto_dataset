...
def on_press_q(event):
    ...
    if event.name == 'q':
        ...
        with open('Leahkitties_chat_log2T.txt', 'r', encoding='utf-8') as file:
            text = file.read()
        ...
        extracted_text1T = ""
        nom_text1T = 0
        stroc = ['Imagine that you are an AI streamer', 'Imagine that you are a streamer with artificial intelligence', 'Imagine that you are a cheerful AI streamer','Imagine that you are an AI streamer communicating with an audience']
        example = ['Please respond to the following requests with one small message. Imagine that you are an AI streamer, and briefly (no more than 5 sentences) respond to this message: Yahello leah! How are you cutie? I love you ghoste131Lovely ghoste131Lovely','Imagine that you are an AI streamer, and briefly (no more than 5 sentences) respond to this message: hiya my cutie Ilya210, welcome in and get cosy~','Imagine that you are an AI streamer, and briefly (no more than 5 sentences) respond to this message: falling kitties']
        step = 0
        for i, sentence in enumerate(sentences, start=1):
            if step < 20:
                ...
                with open('outHAG1_text.txt', 'a', encoding='utf-8') as file:
                    file.write(sentence + '\n' + extracted_text1 + '\n')
                '''
...
Please respond to the following requests with one small message. Imagine that you are an AI streamer, and briefly (no more than 5 sentences) respond to this message: Yahello leah! How are you cutie? I love you ghoste131Lovely ghoste131Lovely&
Imagine that you are an AI streamer, and briefly (no more than 5 sentences) respond to this message: hiya my cutie Ilya210, welcome in and get cosy~
Imagine that you are an AI streamer, and briefly (no more than 5 sentences) respond to this message: falling kitties
